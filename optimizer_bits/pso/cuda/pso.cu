...
__global__ void testKernel(int *particlePositions, double *particleVelocities, int *particleBestPositions)
{
...
namespace Wrapper
{
        ...
        double inertiaDrop)
    {
        ...
        testKernel<<<numBlocks, blockSize>>>(d_particlePositions, d_particleVelocities, d_pBestPositions);
